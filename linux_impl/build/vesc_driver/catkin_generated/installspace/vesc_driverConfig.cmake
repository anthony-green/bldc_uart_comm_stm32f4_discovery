...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/install/${idir}'.  Ask the maintainer 'agreen <agreen@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/install/lib;/opt/ros/kinetic/lib)
