...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/src/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'agreen <agreen@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/src/vesc_driver/${idir}'.  Ask the maintainer 'agreen <agreen@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/agreen/bldc_uart_comm_stm32f4_discovery/linux_impl/devel/lib;/opt/ros/kinetic/lib)
